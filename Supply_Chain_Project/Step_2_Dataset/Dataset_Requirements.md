...
Customer: Stores information about individuals who place orders.
Orders: Records each transaction made by a customer.
OrderItem: Details the specific products and quantities within each order.
Product: Contains information about the items available for sale.
Supplier: Lists the companies that provide the products.
